...
we are going to put the navbar in the base.html file. But just see this code of bootstrap-navbar, it is a huge one and will clutter our base.py file. Navbar · Bootstrap v5.0 (getbootstrap.com). Therefore, I am going to put navbar code inside templates > components folder. First, add this line to base.html.     {% include "components/navbar.html" %}
base.html
